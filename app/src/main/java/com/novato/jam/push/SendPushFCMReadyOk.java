...
public class SendPushFCMReadyOk {
    final static public int TYPE_JOIN = 1;
    final static public int TYPE_SIGNUP = 2;
    ...
    public SendPushFCMReadyOk(Context context, ArrayList<String> fcmKey, String key) {
        init(context, fcmKey, key, TYPE_JOIN );
    }

    public SendPushFCMReadyOk(Context context, ArrayList<String> fcmKey, String key, int join) {
        init(context, fcmKey, key, join );
    }

    private void init(Context context, ArrayList<String> fcmKey, String key, int join) {
