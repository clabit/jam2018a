...
public class SendPushFCMStory {
    static public int STORY_MSG_TYPE_STORY = 1;
    static public int STORY_MSG_TYPE_COMMENT = 2;
    ...
    public SendPushFCMStory(Context context, ArrayList<String> fcmKey, int type, String roomuid, String roomName) {
        setInit(context, fcmKey, type, roomuid, roomName);
    }

    private void setInit(Context context, ArrayList<String> fcmKey, int type, String roomuid, String roomName){
