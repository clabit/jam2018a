...
public class GetGoogleDriveLink {

    String call_url = "https://www.googleapis.com/drive/v3/files";
    ...
    public GetGoogleDriveLink(Context context, String id) {
        ...
        headers = new HashMap();
        headers.put("Authorization","Bearer ya29.AHESVbXTUv5mHMo3RYfmS1YJonjzzdTOFZwvyOAUVhrs");//파이어베이스 사이트에서 설정=>클라우스메시징에 서버키 있음..
