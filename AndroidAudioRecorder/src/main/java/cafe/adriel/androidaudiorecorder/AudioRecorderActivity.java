...
public class AudioRecorderActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            ...
            maxseconded = getIntent().getLongExtra(AndroidAudioRecorder.EXTRA_MAX_SECONDED, -1);
        } else {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if(isRecording) {
                    ...
                    if(maxseconded > 0 && recorderSecondsElapsed == maxseconded){
                        stopPlaying();
                        Util.wait(100, new Runnable() {
                            @Override
                            public void run() {
