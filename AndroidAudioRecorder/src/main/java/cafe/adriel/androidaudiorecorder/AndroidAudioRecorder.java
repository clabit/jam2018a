...
public class AndroidAudioRecorder {
    ...
    protected static final String EXTRA_MAX_SECONDED = "maxseconded";
    ...
    public AndroidAudioRecorder setMaxSeconded(long maxseconded) {
        this.maxseconded = maxseconded;
        return this;
    }
    ...
    public void record() {
        ...
        intent.putExtra(EXTRA_MAX_SECONDED, maxseconded);
